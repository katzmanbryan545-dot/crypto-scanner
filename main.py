...
ЧТО ПИСАТЬ В ДРАЙВЕРЕ:
✅ Если в новостях есть конкретные события — используй их (листинги, запуски, интеграции, инвестиции)
✅ Если свежих крупных новостей НЕТ — укажи реальный драйвер:
   - "Накопление в базе, высокая торговая активность"
   - "Отсутствие давления разлоков на 45+ дней"
   - "Сильный Volume/MCap ratio (укажи процент)"
   - "Технический отскок от уровня поддержки"
